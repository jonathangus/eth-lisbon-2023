...
export class Lenshub__commentWithSig_DispatcherInputVarsStruct extends ethereum.Tuple {
  get profileId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get sig(): Lenshub__commentWithSig_DispatcherInputVarsSigStruct {
    return changetype<Lenshub__commentWithSig_DispatcherInputVarsSigStruct>(
      this[9].toTuple()
    );
  }
}

export class Lenshub__commentWithSig_DispatcherInputVarsSigStruct extends ethereum.Tuple {
  get v(): i32 {
    return this[0].toI32();
  }
...
export class Lenshub__mirrorWithSig_DispatcherInputVarsStruct extends ethereum.Tuple {
  get profileId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get sig(): Lenshub__mirrorWithSig_DispatcherInputVarsSigStruct {
    return changetype<Lenshub__mirrorWithSig_DispatcherInputVarsSigStruct>(
      this[6].toTuple()
    );
  }
}

export class Lenshub__mirrorWithSig_DispatcherInputVarsSigStruct extends ethereum.Tuple {
  get v(): i32 {
    return this[0].toI32();
  }
...
export class Lenshub__postWithSig_DispatcherInputVarsStruct extends ethereum.Tuple {
  get profileId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get sig(): Lenshub__postWithSig_DispatcherInputVarsSigStruct {
    return changetype<Lenshub__postWithSig_DispatcherInputVarsSigStruct>(
      this[6].toTuple()
    );
  }
}

export class Lenshub__postWithSig_DispatcherInputVarsSigStruct extends ethereum.Tuple {
  get v(): i32 {
    return this[0].toI32();
  }
...
export class Lenshub extends ethereum.SmartContract {
  ...
  commentWithSig_Dispatcher(
    vars: Lenshub__commentWithSig_DispatcherInputVarsStruct
  ): BigInt {
    let result = super.call(
      "commentWithSig_Dispatcher",
      "commentWithSig_Dispatcher((uint256,string,uint256,uint256,bytes,address,bytes,address,bytes,(uint8,bytes32,bytes32,uint256))):(uint256)",
      [ethereum.Value.fromTuple(vars)]
    );
  ...
  mirrorWithSig_Dispatcher(
    vars: Lenshub__mirrorWithSig_DispatcherInputVarsStruct
  ): BigInt {
    let result = super.call(
      "mirrorWithSig_Dispatcher",
      "mirrorWithSig_Dispatcher((uint256,uint256,uint256,bytes,address,bytes,(uint8,bytes32,bytes32,uint256))):(uint256)",
      [ethereum.Value.fromTuple(vars)]
    );
  ...
  postWithSig_Dispatcher(
    vars: Lenshub__postWithSig_DispatcherInputVarsStruct
  ): BigInt {
    let result = super.call(
      "postWithSig_Dispatcher",
      "postWithSig_Dispatcher((uint256,string,address,bytes,address,bytes,(uint8,bytes32,bytes32,uint256))):(uint256)",
      [ethereum.Value.fromTuple(vars)]
    );
...
export class CommentWithSig_DispatcherCall extends ethereum.Call {
  get inputs(): CommentWithSig_DispatcherCall__Inputs {
    return new CommentWithSig_DispatcherCall__Inputs(this);
  }

  get outputs(): CommentWithSig_DispatcherCall__Outputs {
    return new CommentWithSig_DispatcherCall__Outputs(this);
  }
}

export class CommentWithSig_DispatcherCall__Inputs {
  _call: CommentWithSig_DispatcherCall;

  constructor(call: CommentWithSig_DispatcherCall) {
    this._call = call;
  }

  get vars(): CommentWithSig_DispatcherCallVarsStruct {
    return changetype<CommentWithSig_DispatcherCallVarsStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }
}

export class CommentWithSig_DispatcherCall__Outputs {
  _call: CommentWithSig_DispatcherCall;
...
export class CommentWithSig_DispatcherCallVarsStruct extends ethereum.Tuple {
  get profileId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get sig(): CommentWithSig_DispatcherCallVarsSigStruct {
    return changetype<CommentWithSig_DispatcherCallVarsSigStruct>(
      this[9].toTuple()
    );
  }
}

export class CommentWithSig_DispatcherCallVarsSigStruct extends ethereum.Tuple {
  get v(): i32 {
    return this[0].toI32();
  }
...
export class MirrorWithSig_DispatcherCall extends ethereum.Call {
  get inputs(): MirrorWithSig_DispatcherCall__Inputs {
    return new MirrorWithSig_DispatcherCall__Inputs(this);
  }

  get outputs(): MirrorWithSig_DispatcherCall__Outputs {
    return new MirrorWithSig_DispatcherCall__Outputs(this);
  }
}

export class MirrorWithSig_DispatcherCall__Inputs {
  _call: MirrorWithSig_DispatcherCall;

  constructor(call: MirrorWithSig_DispatcherCall) {
    this._call = call;
  }

  get vars(): MirrorWithSig_DispatcherCallVarsStruct {
    return changetype<MirrorWithSig_DispatcherCallVarsStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }
}

export class MirrorWithSig_DispatcherCall__Outputs {
  _call: MirrorWithSig_DispatcherCall;
...
export class MirrorWithSig_DispatcherCallVarsStruct extends ethereum.Tuple {
  get profileId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get sig(): MirrorWithSig_DispatcherCallVarsSigStruct {
    return changetype<MirrorWithSig_DispatcherCallVarsSigStruct>(
      this[6].toTuple()
    );
  }
}

export class MirrorWithSig_DispatcherCallVarsSigStruct extends ethereum.Tuple {
  get v(): i32 {
    return this[0].toI32();
  }
...
export class PostWithSig_DispatcherCall extends ethereum.Call {
  get inputs(): PostWithSig_DispatcherCall__Inputs {
    return new PostWithSig_DispatcherCall__Inputs(this);
  }

  get outputs(): PostWithSig_DispatcherCall__Outputs {
    return new PostWithSig_DispatcherCall__Outputs(this);
  }
}

export class PostWithSig_DispatcherCall__Inputs {
  _call: PostWithSig_DispatcherCall;

  constructor(call: PostWithSig_DispatcherCall) {
    this._call = call;
  }

  get vars(): PostWithSig_DispatcherCallVarsStruct {
    return changetype<PostWithSig_DispatcherCallVarsStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }
}

export class PostWithSig_DispatcherCall__Outputs {
  _call: PostWithSig_DispatcherCall;
...
export class PostWithSig_DispatcherCallVarsStruct extends ethereum.Tuple {
  get profileId(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get sig(): PostWithSig_DispatcherCallVarsSigStruct {
    return changetype<PostWithSig_DispatcherCallVarsSigStruct>(
      this[6].toTuple()
    );
  }
}

export class PostWithSig_DispatcherCallVarsSigStruct extends ethereum.Tuple {
  get v(): i32 {
    return this[0].toI32();
  }
