...
export interface IAggregatorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "aggregateSignatures((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[])",
    values: [UserOperationStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "validateSignatures((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],bytes)",
    values: [UserOperationStruct[], PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "validateUserOpSignature((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes))",
    values: [UserOperationStruct]
  ): string;
