...
export interface IEntryPointInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getSenderAddress(bytes)",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getUserOpHash((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes))",
    values: [UserOperationStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "handleAggregatedOps(((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],address,bytes)[],address)",
    values: [IEntryPoint.UserOpsPerAggregatorStruct[], PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "handleOps((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],address)",
    values: [UserOperationStruct[], PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "simulateHandleOp((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes),address,bytes)",
    values: [
      UserOperationStruct,
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>
  ...
  encodeFunctionData(
    functionFragment: "simulateValidation((address,uint256,bytes,bytes,uint256,uint256,uint256,uint256,uint256,bytes,bytes))",
    values: [UserOperationStruct]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "AccountDeployed(bytes32,address,address,address)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "SignatureAggregatorChanged(address)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "UserOperationEvent(bytes32,address,address,uint256,bool,uint256,uint256)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "UserOperationRevertReason"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "UserOperationRevertReason(bytes32,address,uint256,bytes)"
  ): EventFragment;
