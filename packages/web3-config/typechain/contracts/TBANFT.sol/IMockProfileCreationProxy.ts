...
export interface IMockProfileCreationProxyInterface extends utils.Interface {
  functions: {
...
export interface IMockProfileCreationProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMockProfileCreationProxyInterface;
