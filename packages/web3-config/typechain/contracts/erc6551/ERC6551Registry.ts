...
export interface ERC6551RegistryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "account(address,uint256,address,uint256,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "createAccount(address,uint256,address,uint256,uint256,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
  ...
  getEvent(
    nameOrSignatureOrTopic: "AccountCreated(address,address,uint256,address,uint256,uint256)"
  ): EventFragment;
}
